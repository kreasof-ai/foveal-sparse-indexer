...
- **Attention Configuration:** Chunk Size 8, 2/16 active blocks per head (12.5% compute)
...
| :--- | :--- | :--- | :--- |
| **`de-en`** | 30.94 | 0.02 | **0.1%** |
| **`en-ru`** | 22.38 | 0.02 | **0.1%** |
| **`en-ja`** | 18.45 | 0.00 | **0.0%** |
| **`en-zh`** | 36.01 | 0.00 | **0.0%** |
| **`zh-en`** | 15.50 | 0.08 | **0.5%** |
| **`en-es`** | 10.14 | 0.02 | **0.2%** |
| **`ja-en`** | 11.64 | 0.02 | **0.2%** |
| **`en-de`** | 27.77 | 0.02 | **0.1%** |
| **Overall** | **20.86** | **0.02** | **0.1%** |
